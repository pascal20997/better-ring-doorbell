...
(async () => {
  ...
  console.log(
    "The next step is the authorization with ring.com. Please follow the instructions:"
  );
  ...
  await redisClient.hSet(`a`);

  console.log(
    "Use the following information to setup the account linking of your Google Action:"
  );
